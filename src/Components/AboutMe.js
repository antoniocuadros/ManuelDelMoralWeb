    ...
    <div className='back'>
      <div className="AboutMeContainer">
        ...
        <div className='AboutMeHeader'>
              <p data-aos="fade-right" data-aos-duration="1000" className="AboutMeTitle"id="aboutme">About me</p>
        </div>
        <div className="AboutMeTextContainer">
          ...
          <div className='AboutMeTextSecondColumn'>
            <p data-aos="fade-down-right" data-aos-duration="1000" className="AboutMeText">
            ...
            <p data-aos="fade-down-right" data-aos-delay="150" data-aos-duration="1000" className="AboutMeText2">
